      ...
      <>
        <div className="container d-flex justify-content-center align-items-center mt-3 p-2 bg-dark">
          ...
          <div className="col-2 text-center me-2">
              <h1>
                <span className="badge fw-bold border border-dark-subtle bg-secondary-subtle">{<i class="fas fa-clock"></i>}</span>
              </h1>
            </div>
          <div className="col-1 text-center me-3">
              <h1>
                <span className="badge fw-bold border border-light-subtle bg-secondary-subtle">{0}</span>
              </h1>
            </div>
          <div className="col-1 text-center me-3">
              <h1>
